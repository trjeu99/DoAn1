...
class HomeController extends Controller
{
    public function send_mail(){
         //send mail
                $to_name = "Nguyen Dinh Khanh";
                $to_email = "khanh150499@gmail.com";//send to this email
    ...
    public function index(Request $request){
        ...
        //seo 
        $meta_desc = "Shop Linh kiện điện tử"; 
        $meta_keywords = "linh  kien,phu kien ,dien tu";
        $meta_title = "Shop Linh kiện điện tử";
